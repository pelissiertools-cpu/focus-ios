...
enum AppStyle {
    ...
    enum Opacity {
        ...
        nonisolated static let disabled: Double = 0.5
        /// Ghost hints, placeholder-like elements
        nonisolated static let ghost: Double = 0.3
        /// Section divider lines
        nonisolated static let divider: Double = 0.3
        /// Scrim overlays (add bar backdrop, etc.)
        nonisolated static let scrim: Double = 0.15
        /// Card shadow color opacity
        nonisolated static let cardShadow: Double = 0.04
        /// Bottom bar / FAB shadow color opacity
        nonisolated static let barShadow: Double = 0.06
    }
    ...
    enum Spacing {
        ...
        nonisolated static let micro: CGFloat = 2
        ...
        nonisolated static let compact: CGFloat = 8
        /// 10pt — button/icon horizontal padding
        nonisolated static let medium: CGFloat = 10
        /// 12pt — component spacing, medium padding
        nonisolated static let comfortable: CGFloat = 12
        /// 14pt — content padding inside cards/sections
        nonisolated static let content: CGFloat = 14
        /// 16pt — section-level padding
        nonisolated static let section: CGFloat = 16
        /// 20pt — page-level horizontal padding
        nonisolated static let page: CGFloat = 20
        /// 24pt — large section separation
        nonisolated static let expanded: CGFloat = 24
    }
    ...
    enum Layout {
        ...
        nonisolated static let tinyIcon: CGFloat = 18
        /// 20pt — small indicators
        nonisolated static let smallIcon: CGFloat = 20
        /// 24pt — icon frame inside pill/capsule
        nonisolated static let pillButton: CGFloat = 24
        /// 30pt — small icon buttons (ellipsis, close pill)
        nonisolated static let compactButton: CGFloat = 30
        /// 36pt — medium action buttons (save, confirm)
        nonisolated static let iconButton: CGFloat = 36
        /// 44pt — standard touch target (back, nav buttons)
        nonisolated static let touchTarget: CGFloat = 44
        /// 52pt — large secondary actions
        nonisolated static let largeButton: CGFloat = 52
        /// 56pt — floating action button
        nonisolated static let fab: CGFloat = 56
        /// 28pt — icon badge frame (Today, Inbox, Scheduled, etc.)
        nonisolated static let iconBadge: CGFloat = 28
        /// 14pt — section divider icon
        nonisolated static let sectionDividerIcon: CGFloat = 14
        /// 20pt — bottom bar notch radius
        nonisolated static let notchRadius: CGFloat = 20
        /// 40pt — app logo height
        nonisolated static let logoHeight: CGFloat = 40
        /// 280pt — top gradient mist height
        nonisolated static let gradientMistHeight: CGFloat = 280
    }
    ...
    enum Insets {
        ...
        nonisolated static let row = EdgeInsets(top: 0, leading: Spacing.page, bottom: 0, trailing: Spacing.page)
        /// Indented subtask/nested row insets (0, 32, 0, 32)
        nonisolated static let nestedRow = EdgeInsets(top: 0, leading: 32, bottom: 0, trailing: 32)
        /// Zero insets
        nonisolated static let zero = EdgeInsets()
    }
    // MARK: - Corner Radius

    enum CornerRadius {
        /// 7pt — icon badge containers
        nonisolated static let iconBadge: CGFloat = 7
        /// 10pt — pill backgrounds
        nonisolated static let pill: CGFloat = 10
        /// 12pt — cards, drawers, sheets
        nonisolated static let card: CGFloat = 12
        /// 16pt — FAB, project cards (continuous)
        nonisolated static let fab: CGFloat = 16
        /// 25pt — large auth buttons
        nonisolated static let button: CGFloat = 25
    }
    ...
    enum Border {
        ...
        nonisolated static let thin: CGFloat = 0.33
        /// 1pt — standard field/button borders
        nonisolated static let standard: CGFloat = 1
        /// 2pt — focused / selected state borders
        nonisolated static let focused: CGFloat = 2
    }
    ...
    enum Shadow {
        ...
        nonisolated static let cardRadius: CGFloat = 4
        nonisolated static let cardY: CGFloat = 1
        /// Bottom bar shadow: upward lift
        nonisolated static let barRadius: CGFloat = 4
        nonisolated static let barY: CGFloat = -2
        /// FAB shadow: floating elevation
        nonisolated static let fabRadius: CGFloat = 6
        nonisolated static let fabY: CGFloat = 2
    }
